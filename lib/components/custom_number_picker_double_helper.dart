...
class CustomNumberPickerDouble extends StatefulWidget {
  ...
  const CustomNumberPickerDouble({
    Key? key,
  ...
  @override
  _CustomNumberPickerDoubleState createState() =>
      _CustomNumberPickerDoubleState();
}

class _CustomNumberPickerDoubleState extends State<CustomNumberPickerDouble> {
  ...
  void _scrollListener() {
    ...
    final doubleValueInTheMiddle =
        _doubleValueFromIndex(indexOfMiddleElement + additionalItemsOnEachSide);

    if (widget.value != doubleValueInTheMiddle) {
      widget.onChanged(doubleValueInTheMiddle);
      if (widget.haptics) {
  ...
  @override
  void didUpdateWidget(CustomNumberPickerDouble oldWidget) {
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    final value = _doubleValueFromIndex(index % itemCount);
  ...
  double _doubleValueFromIndex(int index) {
    index -= additionalItemsOnEachSide;
    index %= itemCount;
  ...
  void _maybeCenterValue() {
    if (_scrollController.hasClients && !isScrolling) {
      double diff = widget.value - widget.minValue;
